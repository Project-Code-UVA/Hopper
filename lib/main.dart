...
class _MyHomePageState extends State<MyHomePage> {
  ...
  CollectionReference refBarList = FirebaseFirestore.instance.collection('Bars');
  //Stream to hold list of items; "late" because we will initialize it later
  late Stream<QuerySnapshot> streamBarInfo;
  ...
  initState(){
    ...
    streamBarInfo = refBarList.snapshots();
  }
